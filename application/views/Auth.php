...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/backend/') ?>assets/img/favicon.png" rel="icon">
  <link href="<?= base_url('assets/backend/') ?>assets/img/apple-touch-icon.png" rel="apple-touch-icon">
